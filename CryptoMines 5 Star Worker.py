...
def getNewTransactions():
    # try:
    time.sleep(3)
    getFrontPage = 'https://api.cryptomines.app/api/workers?level=5&page=1&limit=8&sort=eternal'
    ...
    for i, d in enumerate(response['data']):
        ...
        data =  json.dumps ( {  
                            ...
                            "embeds": [{
                                ...
                                "thumbnail": { 
                                   "url": "https://cdn.cryptomines.app/videos/workers_s2/rank5/variant1/1.png"
                                }
                            }]
                        } )

        baseURL = "https://discordapp.com/api/channels/{}/messages".format(fiveStar)
